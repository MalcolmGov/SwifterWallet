...
const CONTACTS = [
  { id: "c1", name: "Sarah M.", avatar: "SM", gradient: "linear-gradient(135deg, #ec4899, #f472b6)", phone: "082 341 9012" },
  { id: "c2", name: "David K.", avatar: "DK", gradient: "linear-gradient(135deg, #3b82f6, #60a5fa)", phone: "071 882 3341" },
  { id: "c3", name: "Thabo N.", avatar: "TN", gradient: "linear-gradient(135deg, #10b981, #34d399)", phone: "064 512 8890" },
  { id: "c4", name: "Lisa P.", avatar: "LP", gradient: "linear-gradient(135deg, #f59e0b, #fbbf24)", phone: "083 774 1102" },
  { id: "c5", name: "James R.", avatar: "JR", gradient: "linear-gradient(135deg, #7c3aed, #a78bfa)", phone: "072 993 0045" },
  { id: "c6", name: "Ayanda Z.", avatar: "AZ", gradient: "linear-gradient(135deg, #06b6d4, #22d3ee)", phone: "079 128 6673" },
  { id: "c7", name: "Priya S.", avatar: "PS", gradient: "linear-gradient(135deg, #f43f5e, #fb7185)", phone: "066 451 2234" },
];
